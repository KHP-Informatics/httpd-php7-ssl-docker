...
./configure --with-apxs2=/usr/local/apache2/bin/apxs --without-pear  --enable-mbstring --with-openssl --with-ldap --with-gd --with-zlib --with-mysqli --with-curl --with-mcrypt --enable-zip
make 
make install
